...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(PaymentID, BidID, PaymentAmount, PaymentDate, PaymentStatus) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("issss", $PaymentID, $BidID, $PaymentAmount, $PaymentDate, $PaymentStatus);
    // Set parameters and execute
    $PaymentID = $_POST['book_id'];
    $BidID = $_POST['ride_id'];
    $PaymentAmount = $_POST['passenger_id'];
    $PaymentDate = $_POST['booking_time'];
    $PaymentStatus = $_POST['bookingtime'];
